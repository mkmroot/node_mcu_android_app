...
uint32_t LED1_ON_CODE  = 0xF8F84D2;
uint32_t LED1_OFF_CODE = 0x611B2792;
uint32_t LED2_ON_CODE  = 0x12345678;
uint32_t LED2_OFF_CODE = 0x87654321;
uint32_t LED3_ON_CODE  = 0xABCDEF01;
uint32_t LED3_OFF_CODE = 0x10FEDCBA;
...
void handleIRAdmin() {
  String html = R"rawliteral(
    ...
    <div id="latestIR">Loading...</div>
    <p><a href="/">Back to LED Control</a></p>
    </body></html>
  )rawliteral";
  server.send(200, "text/html", html);
}
